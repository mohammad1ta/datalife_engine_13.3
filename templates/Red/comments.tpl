<div class="comment[comments-author] com_author[/comments-author]" id="{comment-id}">
	...
	<div class="grid_1_4">
		...
		<div class="rate">
			...
			[rating-type-2]
				<div class="rate_like" title="موافقم">
				[rating-plus]
	...
	<div class="com_content">
		<div class="com_info">
			...
			[offline]<span title="Offline" class="status offline">آنلاین</span>[/offline]
		...
		<div class="com_tools">
			...
			<span class="edit_btn" title="ویرایش">
			[com-edit]<i></i>[/com-edit]
			</span>
			[/not-group]
			<div class="com_tools_links grey">
				[fast]<svg class="icon icon-meta_reply"><use xlink:href="#icon-meta_reply"></use></svg><span>نقل قول</span>[/fast]
				[treecomments] 
					[reply]<svg class="icon icon-meta_reply"><use xlink:href="#icon-meta_reply"></use></svg><span>پاسخ</span>[/reply]
				[/treecomments] 
				[com-del]<svg class="icon icon-cross"><use xlink:href="#icon-cross"></use></svg><span>حذف</span>[/com-del]
