...
<div class="comments">
	...
	<div class="section">
		...
		<div class="cm-head">
			<div class="right">
				<strong>{author}</strong> در <strong>{date}</strong> گفته:
			</div>
			<div class="left">
				[reply]<i class="flaticon-chat"></i>پاسخ[/reply]
				[complaint]<i class="flaticon-pencil"></i>گزارش[/complaint]
				[ignore]<i class="flaticon-close"></i>افزودن به لیست سیاه[/ignore]
				[del]<i class="flaticon-trash"></i>حذف[/del]
			</div>
		</div>
